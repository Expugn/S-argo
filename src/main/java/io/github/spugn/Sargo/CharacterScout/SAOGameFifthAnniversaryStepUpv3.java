...
/**
 * SAO GAME 5TH ANNIVERSARY CHARACTER SCOUT V3
 * <p>
 ...
 *
 *     This differs from {@link SAOGameFifthAnniversaryStepUpv2} by
 *     including a guarantee for Gold or Platinum rarity characters
 *     on the first step.
 * </p>
 * <p>
 *     STEP CHANGES:<br>
 ...
 *          - One Gold+ rarity character is guaranteed.<br>
 *     Step 3)<br>
    ...
    protected void setupScoutMenu()
    {
        ...
        else
        {
            switch (CHOICE.toLowerCase())
            {
                ...
                case "m":
                case "mi":
                    simpleMessage += "**[SAO Game 5th Anniversary Step Up v3] - Step " + bannerTypeData + "**" + "\n";
                    break;
                default:
                    simpleMessage += "**[SAO Game 5th Anniversary Step Up v3] - Unknown**" + "\n";
                    break;
            }
        }
    }
